...
from picosvgx.geometric_types import Vector
from picosvgx.svg_types import SVGCircle, SVGPath, SVGRect
from picosvgx.svg_transform import Affine2D
from picosvgx.svg_reuse import _affine_friendly, _vectors, normalize, affine_between
import pytest
